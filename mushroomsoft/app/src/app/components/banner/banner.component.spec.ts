...
describe('BannerComponent', () => {
      ...
      [
        {
          ...
          class:"ms-about-grid",
          title:"Who we are",
          description:"We are MushroomSoft IT, an Ecuadorian software company that leverages new technologies and high-performance developer teams to deliver exceptional quality products.We create solutions that address tomorrow's challenges through innovation and technology.",
  ...
  it('should initialization of the component', () => {
    ...
    app.ngOnInit();
    expect(app.sectionItems).toEqual(mockBanner);
  });
});
