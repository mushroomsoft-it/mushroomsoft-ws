...
describe('TechnologyComponent', () => {
  ...
  const mockTechnology = {
    title:
      {
        title: "Technology",
        description: "We implement software development projects in a wide range of cutting-edge technologies. Our team of specialists are qualified in various technologies. We would love to discuss and recommend the best solution for your business' needs."
      },
    service:
      [
        {
  ...
  it('should initialization of the component', () => {
    ...
    app.ngOnInit();
    expect(app.technologyItemsService).toEqual(mockTechnology.service);
  });
});
